...
const Navbar = () => {
  ...
  const {connectWallet, connectedAccount, transactions} = useContext(TransactionContext);
  ...
  return (
    <nav className='w-full flex md:justify-center justify-between items-center p-4'>
      <div className='md:flex-[0.5] flex-initial justify-center items-center'>
        <img src={logo} alt="logo" className='w-32 cursor-pointer' style={{filter: 'invert(1)', height: '96px'}}/>
      </div>
      ...
      <div className='flex relative'>
        ...
        />} 
        {toggleMenu && (
          <ul className='z-10 fixed top-0 -right-2 p-3 w-[70vw] h-screen shadow-2xl list-none
